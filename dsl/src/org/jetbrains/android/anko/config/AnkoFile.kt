...
public enum class AnkoFile(
    ...
    LISTENERS(setOf(PLATFORM, TOOLKIT, SUPPORT_V4)),
    OTHER(setOf(PLATFORM)),
    OTHER_WIDGETS(setOf(PLATFORM)),
    PROPERTIES(setOf(PLATFORM, TOOLKIT, SUPPORT_V4)),
    SERVICES(setOf(PLATFORM, TOOLKIT, SUPPORT_V4)),
    SQL_PARSER_HELPERS(setOf(COMMON)),
    VIEWS(setOf(PLATFORM, TOOLKIT, SUPPORT_V4), { it[VIEWS] || it[ConfigurationTune.HELPER_CONSTRUCTORS] });
